...
This [post](http://help.plotly.com/embed-graphs-in-websites/) has more details on how to embed Chart Studio graphs within HTML `iframes`, but you could also use Chart Studio's built-in image export by simply adding a `.png` or `.jpeg` file extension to the end of the figure's URL. 
